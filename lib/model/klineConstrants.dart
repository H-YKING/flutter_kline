...
const String kDefaultPeriod = '60';
const List<String> kPeriodList = ['1', '5', '15', '30', '60', '1D', '1W', '1M'];
const List<String> kPeriodTitleList = [
  '1分钟',
  '5分钟',
  '15分钟',
  '30分钟',
...
/**********************************时间选择相关配置**********************************/
const Color hDefaultTextColor = Color(0xff7287A5);
const Color hSelectedTextColor = Color(0xff52cea2);
const Color hIndicatorColor = Color(0xff52cea2);
